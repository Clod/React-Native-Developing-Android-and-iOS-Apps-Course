...
import {
  FlatList, ScrollView, View, ImageBackground, Text, Image, Dimensions, StyleSheet, TouchableOpacity
} from 'react-native';
...
//   It is designed to display a carousel of images with left and right arrow buttons, which will be created by you in next.
//   The arrows would allow the user to navigate through the images. This component takes in an images prop, which will hold the URLs for apartment images to be displayed.
